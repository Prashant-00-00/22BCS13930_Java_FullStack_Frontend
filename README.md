...
1. Clone the backend repository:
   ...
   ```bash
   git clone https://github.com/Prashant-00-00/22BCS13930_Java_FullStack_Backend.git

1. Clone the Frontend repository:

   ```bash
    git clone https://github.com/Prashant-00-00/22BCS13930_Java_FullStack_Frontend.git
